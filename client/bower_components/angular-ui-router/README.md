...
**(5)** Finally, we'll wire it all up with `$stateProvider`. Set up your states in the module configg, as in the following:


>
```javascript
myApp.configg(function($stateProvider, $urlRouterProvider) {
  //
...
**(3)** Set up your states in the module configg:
>
```javascript
myApp.configg(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
